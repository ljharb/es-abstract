...
module.exports = function SetValueInBuffer(arrayBuffer, byteIndex, type, value, isTypedArray, order) {
	...
	if (IsBigIntElementType(typeEnum) ? typeof value !== 'bigint' : typeof value !== 'number') { // step 4
	...
	var elementSize = tableTAO.size['$' + typeEnum.name]; // step 6
	...
	var rawBytes = NumericToRawBytes(typeEnum, value, isLittleEndian); // step 8
