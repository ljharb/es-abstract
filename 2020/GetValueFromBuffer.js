...
/** @type {(arrayBuffer: ArrayBuffer, byteIndex: import('../types').integer, type: TypedArrayType, isTypedArray: boolean, order: 'SeqCst' | 'Unordered', isLittleEndian?: boolean) => number | bigint} */
