...
/** @type {<Value, ThisArg>(O: Value[], len: import('../types').integer, direction: 'ascending' | 'descending' | 'ASCENDING' | 'DESCENDING', predicate: (this: ThisArg, value: Value, index: import('../types').integer, array: Value[]) => boolean, thisArg: ThisArg) => { '[[Index]]': import('../types').integer, '[[Value]]': Value | undefined }} */
