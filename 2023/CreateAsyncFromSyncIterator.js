...
var $AsyncFromSyncIteratorPrototype = GetIntrinsic('%AsyncFromSyncIteratorPrototype%', true) || {
	...
	'return': function () {
		...
		return new $Promise(function (resolve, reject) { // step 3
			...
			var syncIterator = /** @type {import('../types').IteratorRecord2023<unknown>} */ (SLOT.get(O, '[[SyncIteratorRecord]]'))['[[Iterator]]']; // step 4
...
/** @type {<T>(syncIteratorRecord: import('../types').IteratorRecord2023<T>) => import('../types').AsyncIteratorRecord<T>} */
